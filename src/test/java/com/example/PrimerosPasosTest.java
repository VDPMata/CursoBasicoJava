...
public class PrimerosPasosTest {
    ...
    void testNum() {
        ...
        Assertions.assertTrue(resultado >= Integer.MIN_VALUE && resultado <= Integer.MAX_VALUE,
                "El resultado no es de tipo Int");
    }
    ...
    void testNumDecimal() {
        ...
        Assertions.assertTrue(!Double.isNaN(resultado) && !Double.isInfinite(resultado),
                "El resultado no es de tipo Double");
    }
    ...
    void testArgDolares() {
        ...
        Assertions.assertEquals(780000, resultado, "el resultado deberia ser 525000");
    }
